...
avg_age <- mean(fitness$age, na.rm = TRUE)
avg_duration <- mean(fitness$duration_min, na.rm = TRUE)
avg_calories_burned <- mean(fitness$calories_burned, na.rm = TRUE)
avg_heart_rate <- mean(fitness$heart_rate_avg, na.rm = TRUE)
avg_steps <- mean(fitness$steps, na.rm = TRUE)
avg_sleep_hours <- mean(fitness$sleep_hours, na.rm = TRUE)
avg_weight <- mean(fitness$weight_kg, na.rm = TRUE)

median_age <- median(fitness$age, na.rm = TRUE)
median_duration <- median(fitness$duration_min, na.rm = TRUE)
median_calories_burned <- median(fitness$calories_burned, na.rm = TRUE)
median_heart_rate <- median(fitness$heart_rate_avg, na.rm = TRUE)
median_steps <- median(fitness$steps, na.rm = TRUE)
median_sleep_hours <- median(fitness$sleep_hours, na.rm = TRUE)
median_weight <- median(fitness$weight_kg, na.rm = TRUE)
