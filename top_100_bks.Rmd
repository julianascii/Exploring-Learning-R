...
# check if max year can be examined
summary(books)
table(duplicated(books$Year))

# find the year with most books published
...
# identify which books these are
bk <- books %>%
  group_by(Year, 
           Author, 
           Title) %>%
...
# identify at what age on average these books were puclished
